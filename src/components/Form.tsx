...
const handleSubmit = async (event: React.FormEvent) => {
  ...
  formData.append("religion", form.religion.value);
  formData.append("residentStatus", form.residentStatus.value);
  formData.append("maritalStatus", form.maritalStatus.value);
  formData.append("city", form.city.value);
  formData.append("state", form.state.value);
  formData.append("postal-code", form.postalCode.value);
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex my-4">
            <div className="w-1/3 flex items-center border-b-2 border-black me-4">
              <label htmlFor="fullName" className="mr-4 pb-2">
                Full Name:
              </label>
              <input
                type="text"
          ...
          <div className="my-4 flex flex-col">
            ...
            <div className="flex my-4">
              <div className="w-1/3 flex items-center border-b-2 border-black me-4">
                <label htmlFor="postal-code" className="mr-4 pb-2">
                  Postal Code :
                </label>
                <input
                  type="text"
